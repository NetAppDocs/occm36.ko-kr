...
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_supported_configs_94.html["Cloud Volumes ONTAP 9.4에 지원되는 구성"^]
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_supported_configs_93.html["ONTAP 클라우드 9.3에서 지원되는 구성"^]
...
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_storage_limits_95.html["Cloud Volumes ONTAP 9.5의 보관 제한"^]
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_storage_limits_94.html["Cloud Volumes ONTAP 9.4의 스토리지 제한"^]
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_storage_limits_93.html["ONTAP 클라우드 9.3의 스토리지 제한"^]
