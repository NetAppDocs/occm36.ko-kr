...
Cloud Volumes ONTAP는 AWS 및 Azure에서 BYOL(Pay-as-you-go and Bring Your Own License)의 두 가지 가격 옵션으로 제공됩니다. 선불 종량제 의 경우 Explore, Standard 또는 Premium의 세 가지 라이센스 중에서 선택할 수 있습니다. 각 라이센스는 용량과 컴퓨팅 옵션을 다르게 제공합니다.

* https://["Cloud Volumes ONTAP 9.5에 지원되는 구성입니다"^]
* https://["Cloud Volumes ONTAP 9.4에 지원되는 구성"^]
* https://["ONTAP 클라우드 9.3에서 지원되는 구성"^]
...
* https://["Cloud Volumes ONTAP 9.5의 보관 제한"^]
* https://["Cloud Volumes ONTAP 9.4의 스토리지 제한"^]
* https://["ONTAP 클라우드 9.3의 스토리지 제한"^]
...
+
https://["AWS 문서: Amazon EC2 인스턴스 유형"^]
https://["AWS 문서: Amazon EBS – 최적화된 인스턴스"^]



--
EBS 디스크 유형입니다:: 범용 SSD는 Cloud Volumes ONTAP의 가장 일반적인 디스크 유형입니다. EBS 디스크의 사용 사례를 보려면 을 참조하십시오 http://["AWS 설명서:EBS 볼륨 유형"^].
...
+
EBS 디스크 성능에 대한 자세한 내용은 을 참조하십시오 http://["AWS 설명서:EBS 볼륨 유형"^].
...
가상 머신 유형입니다:: 에서 지원되는 가상 머신 유형을 확인합니다 http://["Cloud Volumes ONTAP 릴리즈 노트"^] 지원되는 각 VM 유형에 대한 세부 정보를 검토합니다. 각 VM 유형은 특정 수의 데이터 디스크를 지원합니다.
+
--
* https://["Azure 설명서: 범용 가상 머신 크기"^]
* https://["Azure 설명서: 메모리에 최적화된 가상 머신 크기"^]
...
* https://["Microsoft Azure: 관리형 디스크 가격"^]
* https://["Microsoft Azure: 페이지 Blob 가격 책정"^]
